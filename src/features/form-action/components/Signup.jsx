...
export default function Signup() {
  ...
  function signupAction(prevFromState, formData) {
    ...
    const confirmPassrod = formData.get("confirmPassrod");
  ...
  return (
    <form action={formAction}>
      ...
      <div className="control-row">
        ...
        <div className="control">
          ...
          <input
            ...
            defaultValue={formState.enteredValues.confirmPassrod}
          />
        </div>
      </div>
      ...
      <div className="control">
        ...
        <select id="role" name="role" defaultChecked={formState.enteredValues?.role}>
